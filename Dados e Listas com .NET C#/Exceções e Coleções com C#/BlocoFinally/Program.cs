...
try {
    ...
    string[] linhas = File.ReadAllLines("Arquivos/arquivoLeitura.txt"); // forced error
    ...
    Console.WriteLine("Exceções tratadas.");
    // normalmente utilizado para fechar comunicações, etc.
}